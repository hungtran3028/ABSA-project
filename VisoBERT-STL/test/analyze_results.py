...
# Tạo thư mục cho results (tự động detect project root)
import os
from pathlib import Path
...
def load_predictions(predictions_file=None, test_file=None):
    """
    ...
    """
    # Auto-detect project root and set default paths (try multiple locations)
    if predictions_file is None:
        ...
        for path in _possible_pred_paths:
            ...
            predictions_file = str(_possible_pred_paths[0])  # Default
    ...
    if test_file is None:
        ...
        for path in _possible_test_paths:
            ...
            test_file = str(_possible_test_paths[0])  # Default
...
def main():
    ...
    # Load predictions (auto-detect paths)
    df = load_predictions()
