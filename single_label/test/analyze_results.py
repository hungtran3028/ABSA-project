...
RESULTS_DIR = "single_label/analysis_results"
os.makedirs(RESULTS_DIR, exist_ok=True)


def load_predictions(file_path="single_label/results/test_predictions_single.csv"):
...
def main():
    ...
    # Load predictions
    df = load_predictions("single_label/results/test_predictions_single.csv")
